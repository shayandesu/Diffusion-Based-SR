...
# from mdlm.smiles_tokenizer import SMILESTokenizer
...
def get_chebi_dataset(cache_dir, text_tokenizer, mode='train'):
    ...
    smiles_tokenizer.load_vocabulary('/home/xulei/shayan/SR/smiles-mdlm/smiles_vocab.txt')
    ...
    def process_examples(examples):
        ...
        for smiles in examples['SMILES']:
            ...
            # Create attention mask (1 for real tokens, upweight eos, downweight pad tokens)
